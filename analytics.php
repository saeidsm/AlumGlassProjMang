...
<body>
    <div class="container-fluid mt-4">
        <div class="card">
            <div class="card-header">
                <h3><i class="bi bi-bar-chart-line"></i> تحلیل‌های تفصیلی</h3>
            </div>
            <div class="card-body">
                <!-- Filter Section -->
    ...
    <script>
        // Helper to convert Gregorian 'YYYY-MM-DD' to Jalali 'YYYY/MM/DD'
        function toJalali(gregorianDateStr) {
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const tasksTable = $('#tasksTable').DataTable({
                language: { url: '//cdn.datatables.net/plug-ins/1.11.5/i18n/fa.json' }
            });
            ...
            async function loadData() {
                ...
                try {
                    ...
                    // 2. Populate Charts
                    const labels = data.chartData.map(d => toJalali(d.period_start_date));
