<?php
// /public_html/ghom/api/get_plan_elements.php (DEFINITIVE CORRECTED VERSION V4)
...
try {
    ...
    foreach ($elements as $element_id => $element) {
        ...
        if ($user_role === 'superuser' || ($user_role === 'admin' && $final_data['status'] !== 'OK') || (in_array($user_role, ['cat', 'car', 'coa', 'crs']) && $final_data['status'] === 'Repair')) {
