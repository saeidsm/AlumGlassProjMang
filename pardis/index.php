...
.element-selected {
 ...
 #layerControlsContainer .btn-group .btn {
            background-color: #6c757d; /* A default Bootstrap secondary color */
            border-color: #6c757d;
            color: white;
        }

        /* This targets the primary (blue) dropdown button */
        #layerControlsContainer .btn-group .btn-primary {
            background-color: #007bff;
            border-color: #007bff;
        }

        /* This ensures the hover/active states also work */
        #layerControlsContainer .btn-group .btn:hover {
            opacity: 0.85;
        }
...
.gltf-control-section {
    margin-bottom: 20px;
}

.gltf-control-section h3 {
    font-size: 14px;
    color: #495057;
    margin-bottom: 10px;
    padding-bottom: 5px;
...
.gltf-control-btn.secondary {
    background-color: #6c757d;
}

.gltf-control-btn.secondary:hover {
    background-color: #545b62;
}

.gltf-checkbox-control {
    display: flex;
    align-items: center;
    margin-bottom: 10px;
    font-size: 13px;
...
.gltf-checkbox-control input[type="checkbox"] {
    margin-left: 8px;
    cursor: pointer;
}
...
.gltf-spinner {
    ...
    width: 50px;
    height: 50px;
    animation: gltf-spin 1s linear infinite;
    margin-bottom: 15px;
}
