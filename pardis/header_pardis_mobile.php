...
$pageTitle = isset($pageTitle) ? $pageTitle : 'پروژه دانشگاه پردیس'; // Default title for Fereshteh
...
<head>
    ...
    <!-- ... other head elements ... -->
<link rel="stylesheet" href="/pardis/assets/css/mobile.css">
<link rel="stylesheet" href="/pardis/assets/css/jalalidatepicker.min.css" />
    <link href="/assets/css/datatables.min.css" rel="stylesheet">
    <link rel="stylesheet" href="/pardis/assets/css/crack1.css" />
...
<body>
    <div class="main-container">
        ...
        <nav class="nav-container">
            <nav class="main-nav" id="main-nav">
                    <?php if (hasAccess(['admin', 'superuser','planner','supervisor', 'user', 'cat', 'car', 'cod', 'crs'])): ?>
                        <!-- Home Dropdown -->
 ...
 <a href="viewer_3d.php" class="nav-dropdown-item<?php echo getActiveClass('viewer_3d.php', $current_page_filename); ?>">
    🏗️ نمایشگر مدل‌های سه‌بعدی
                    ...
                    <?php endif; ?>
                                ...
                                <a href="project_schedule.php" class="nav-dropdown-item<?php echo getActiveClass('project_schedule.php', $current_page_filename); ?>">
                                    نمایش برنامه
                                </a>
                                ...
                                <?php if (hasAccess(['superuser'])): ?>
                                    <a href="record_management.php" class="nav-dropdown-item<?php echo getActiveClass('record_management.php', $current_page_filename); ?>">
                                        مدیریت رکوردها
                                    </a>
                                <?php endif; ?>
