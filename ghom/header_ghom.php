...
<body>
 ...
 <nav class="main-nav" id="main-nav">
                ...
                <?php endif; ?>
                                 <?php if (hasAccess(['admin', 'superuser', 'user', 'cat', 'car', 'coa', 'crs'])): ?>
                    <a href="daily_reports_dashboard.php" class="nav-dropdown-item<?php echo getActiveClass('daily_reports_dashboard.php', $current_page_filename); ?>">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                            <rect x="3" y="3" width="7" height="7" rx="1" ry="1" />
                            <rect x="14" y="3" width="7" height="7" rx="1" ry="1" />
                            <rect x="3" y="14" width="7" height="7" rx="1" ry="1" />
...
گزارشات رروزانه
                ...
                <?php endif; ?>
                <?php if (hasAccess(['superuser','admin'])): ?>
                    <a href="workshop_qc.php" class="nav-dropdown-item<?php echo getActiveClass('workshop_qc.php', $current_page_filename); ?>">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none"
                            viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"
                            stroke-linecap="round" stroke-linejoin="round">
                            <path d="M9 6h11" />
          ...
          document.addEventListener("DOMContentLoaded", () => {
            ...
            if (typeof WeatherIntegration !== 'undefined') {
               ...
               const headerWidgetConfig = {
                    apiEndpoint: '/ghom/weather_api.php',
                    ...
                    // Set the location permanently to 'ghom'
                    location: 'ghom'
                };
...
<script src="/ghom/assets/js/weather_integration.js"></script>
</body>
</html>