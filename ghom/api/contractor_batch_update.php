...
<style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .permit-label { font-family: Tahoma, sans-serif; font-size: 14px; font-weight: bold; fill: #000; stroke: #fff; stroke-width: 0.5px; pointer-events: none; text-anchor: middle; dominant-baseline: middle; }
